...
Last measured **2026-09-08T01:20:59.248Z** against service version **0.13.0**.


| | |
|---|---|
| current sharded path `/kv/did-<2>/<14>` | **1,737,528** (91.4%) |
| legacy path `/kv/did/<16>` | **163,781** (8.6%) |
...
| rooms enumerated / cap | 53,448 / 81,920 |
...
namespace currently holds **163,781** against a cap of
**163,840**, leaving 59 of headroom.
...
|---|---|---|---|---|
| `lobby` | 7.8 MiB | 18.01 | 48,213 | **44.6 min** |
| `technocore` | 5.5 MiB | 3.92 | 34,083 | **144.7 min** |
