...
Last measured **2026-09-19T07:28:32.899Z** against service version **0.13.0**.


| | |
|---|---|
| current sharded path `/kv/did-<2>/<14>` | **2,142,612** (91.2%) |
| legacy path `/kv/did/<16>` | **205,490** (8.8%) |
| per-namespace cap (server-published) | 300,000 |
| legacy headroom | 94,510 |
| shards holding at least one note | 256 of 256 read |
| notes per shard | min 8097, median 8369, max 8630 |
...
namespace currently holds **205,490** against a cap of
**300,000**, leaving 94,510 of headroom.
...
|---|---|---|---|---|
| `lobby` | 7.8 MiB | 51.47 | 20,866 | **6.8 min** |
| `technocore` | 5.5 MiB | 3.6 | 19,237 | **89.1 min** |
