...
// --- yesterday's census, nothing new since ------------------------------------------
{
  ...
  // A morning reader sees 15-18 hours because the census lands 16-18 KST, and that is
  // the newest measurement in existence rather than a stale one. The number alone reads
  // as staleness, so the page says which it is.
